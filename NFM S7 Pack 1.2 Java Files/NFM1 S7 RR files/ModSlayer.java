...
public class ModSlayer
{
    ...
    static final byte sunfmt[] = {
        46, 115, 110, 100, 0, 0, 0, 24, 127, 127, 
    ...
    final void mixtrack_16_mono(ModTrackInfo modtrackinfo, int ai[], int i, int j)
    {
        ...
        int l = vol_adj[modtrackinfo.volume] * gain >> vol_shift + 8;
        int i1 = modtrackinfo.error;
        int j1 = modtrackinfo.pitch & 0xfff;
