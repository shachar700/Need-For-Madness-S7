...
public class ContO {
    ...
    public ContO(byte[] abyte0, Medium medium, Trackers trackers) {
        ...
        float f = 1.0f;
        float f1 = 1.0f;
        float[] af = new float[]{1.0f, 1.0f, 1.0f};
        int[] ai = new int[100];
        int[] ai1 = new int[100];
        int[] ai2 = new int[100];
        int[] ai3 = new int[3];
        ...
        try {
            ...
            while ((s = datainputstream.readLine()) != null) {
                ...
                if (flag) {
                    ...
                    if (s1.startsWith("p")) {
                        ai[i] = (int)((float)this.getvalue("p", s1, 0) * f * f1 * af[0]);
                        ai1[i] = (int)((float)this.getvalue("p", s1, 1) * f * af[1]);
                        ai2[i] = (int)((float)this.getvalue("p", s1, 2) * f * af[2]);
                ...
                if (s1.startsWith("w")) {
                    this.keyx[j] = (int)((float)this.getvalue("w", s1, 0) * f * af[0]);
                    this.keyz[j] = (int)((float)this.getvalue("w", s1, 2) * f * af[2]);
                    ++j;
                    wheels.make(this.m, this.t, this.p, this.npl, (int)((float)this.getvalue("w", s1, 0) * f * f1 * af[0]), (int)((float)this.getvalue("w", s1, 1) * f * af[1]), (int)((float)this.getvalue("w", s1, 2) * f * af[2]), this.getvalue("w", s1, 3), (int)((float)this.getvalue("w", s1, 4) * f * f1), (int)((float)this.getvalue("w", s1, 5) * f), i1);
                    this.npl += 15;
                }
                ...
                if (s1.startsWith("ScaleX")) {
                    af[0] = (float)this.getvalue("ScaleX", s1, 0) / 100.0f;
                }
                if (s1.startsWith("ScaleY")) {
                    af[1] = (float)this.getvalue("ScaleY", s1, 0) / 100.0f;
                }
                if (s1.startsWith("ScaleZ")) {
                    af[2] = (float)this.getvalue("ScaleZ", s1, 0) / 100.0f;
                }
