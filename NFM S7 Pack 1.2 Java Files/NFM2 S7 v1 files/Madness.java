...
public void drive(Control control, ContO conto, Trackers trackers, CheckPoints checkpoints)
    {
        ...
        if(wtouch && k3 == 2)
        {
            conto.zy += (int)((double)((m.random() * 25F * speed) / (float)swits[cn][2] - (15F * speed) / (float)swits[cn][2]) * ((double)bounce[cn] - 0.99999999999999989D));
            conto.xy += (int)((double)((m.random() * 25F * speed) / (float)swits[cn][2] - (15F * speed) / (float)swits[cn][2]) * ((double)bounce[cn] - 0.99999999999999989D));
        }
        if(wtouch && k3 == 1)
        {
            conto.zy += (int)((double)((m.random() * 20F * speed) / (float)swits[cn][2] - (10F * speed) / (float)swits[cn][2]) * ((double)bounce[cn] - 0.99999999999999989D));
            conto.xy += (int)((double)((m.random() * 20F * speed) / (float)swits[cn][2] - (10F * speed) / (float)swits[cn][2]) * ((double)bounce[cn] - 0.99999999999999989D));
        }
