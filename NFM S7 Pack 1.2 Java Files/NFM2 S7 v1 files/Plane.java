...
public class Plane {
    ...
    public Plane(Medium medium, Trackers trackers, int[] ai, int[] ai1, int[] ai2, int i, int[] ai3, boolean flag, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag1, int i2) {
        this.m = medium;
        this.t = trackers;
        this.n = i;
    ...
    public void d(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag, int i2) {
        ...
        if (this.embos == 0) {
            ...
            if (this.embos >= 16) {
                ...
                if ((i9 = (int)(169.0f + 169.0f * ((float)this.m.snap[1] / 300.0f))) > 255) {
                    i9 = 255;
                }
                if (i9 < 0) {
                    i9 = 0;
                }
                if ((k9 = (int)(89.0f + 89.0f * ((float)this.m.snap[2] / 200.0f))) > 255) {
                    k9 = 255;
                }
                if (k9 < 0) {
                    k9 = 0;
