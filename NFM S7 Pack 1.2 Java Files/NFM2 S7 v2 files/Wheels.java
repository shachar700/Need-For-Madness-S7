...
public class Wheels {
    ...
    public void make(Medium medium, Trackers trackers, Plane[] p, int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
        int[] ai = new int[16];
        int[] ai1 = new int[16];
        int[] ai2 = new int[16];
        ...
        p[i] = new Plane(medium, trackers, ai, ai2, ai1, 16, ai3, false, l1, 0, i2, k, l, 7, 0, false, 0, false);
        ++this.mast;
        p[i].master = this.mast;
        ++i;
        ...
        p[i] = new Plane(medium, trackers, ai, ai2, ai1, 3, this.rc, false, j2, 0, i2, k, l, 7, 0, false, 0, false);
        ...
        p[++i] = new Plane(medium, trackers, ai, ai2, ai1, 4, ai3, false, l1, -1 * byte0, i2, k, l, 7, 0, false, 0, false);
        ai[0] = (int)((float)j - 4.0f * f);
