...
public class GameSparker extends Panel
        ...
        try {
            ...
            while ((s = datainputstream.readLine()) != null) {
                ...
                if (s1.startsWith("nlaps")) {
                    ...
                    if (checkpoints.nlaps > 3)
                        checkpoints.nlaps = checkpoints.nlaps + rand.nextInt(4) - 1;
                }
    ...
    public void run() {
        ...
        ContO aconto1[] = new ContO[100000];
    ...
    public void createAndShowFrame() {
        if (frame != null)
            frame.dispose();
        frame = new Frame("NEED FOR MADNESS S7 RETRO REVERENCE");
