...
public class Madness
{
    ...
    public void drive(Control control, ContO conto, Trackers trackers, CheckPoints checkpoints)
    {
        ...
        if(mtouch)
        {
            ...
            {
                if(k3 == 1)
                    f6 = (float)((double)f6 * 0.074999999999999997D);
            } else
            if(k3 == 1)
            ...
            do
                if(!aflag[i7] && af[i7] > (float)(trackers.x[j5] - trackers.radx[j5]) && af[i7] < (float)(trackers.x[j5] + trackers.radx[j5]) && af1[i7] > (float)(trackers.z[j5] - trackers.radz[j5]) && af1[i7] < (float)(trackers.z[j5] + trackers.radz[j5]) && af2[i7] > (float)(trackers.y[j5] - trackers.rady[j5]) && af2[i7] < (float)(trackers.y[j5] + trackers.rady[j5]))
                {
                    if(trackers.xy[j5] == 0 && trackers.zy[j5] == 0 && trackers.y[j5] != 250 && af2[i7] > (float)(trackers.y[j5] - 5))
                    {
                        ...
                        int f133 = 0;
                        do
                            if((float)i7 != f13 && af2[f133] <= (float)(trackers.y[j5] - 5))
                                af2[f133] -= af2[i7] - (float)trackers.y[j5];
                        while(++f13 < 4F);
                    ...
                    if(trackers.zy[j5] == -90 && af1[i7] < (float)(trackers.z[j5] + trackers.radz[j5]) && scz[i7] < 0.0F)
                    {
                        ...
                        int f144 = 0;
                        do
                            if(i7 != f144 && af1[f144] >= (float)(trackers.z[j5] + trackers.radz[j5]))
                                af1[f144] -= af1[i7] - (float)(trackers.z[j5] + trackers.radz[j5]);
                        while(++f14 < 4F);
                    ...
                    if(trackers.zy[j5] == 90 && af1[i7] > (float)(trackers.z[j5] - trackers.radz[j5]) && scz[i7] > 0.0F)
                    {
                        ...
                        int f155 = 0;
                        do
                            if(i7 != f155 && af1[f155] <= (float)(trackers.z[j5] - trackers.radz[j5]))
                                af1[f155] -= af1[i7] - (float)(trackers.z[j5] - trackers.radz[j5]);
                        while(++f15 < 4F);
                    ...
                    if(trackers.xy[j5] == -90 && af[i7] < (float)(trackers.x[j5] + trackers.radx[j5]) && scx[i7] < 0.0F)
                    {
                        ...
                        int f166 = 0;
                        do
                            if(i7 != f166 && af[f166] >= (float)(trackers.x[j5] + trackers.radx[j5]))
                                af[f166] -= af[i7] - (float)(trackers.x[j5] + trackers.radx[j5]);
                        while(++f16 < 4F);
                    ...
                    if(trackers.xy[j5] == 90 && af[i7] > (float)(trackers.x[j5] - trackers.radx[j5]) && scx[i7] > 0.0F)
                    {
                        ...
                        int f177 = 0;
                        do
                            if(i7 != f177 && af[f177] <= (float)(trackers.x[j5] - trackers.radx[j5]))
                                af[f177] -= af[i7] - (float)(trackers.x[j5] - trackers.radx[j5]);
                        while(++f17 < 4F);
        ...
        if(im == 0)
        {
            if(control.wall != -1)
                control.wall = -1;
            if(control.up)
                xt.drawcs(320 + xt.addy, "^", 150, 0, 0, 0);
            if(control.down)
                xt.drawcs(330 + xt.addy, "v", 150, 0, 0, 0);
            if(control.left)
                xt.draws(330 + xt.addy, 315 + xt.addx, 11, "<", 150, 0, 0, 0);
            if(control.right)
                xt.draws(330 + xt.addy, 345 + xt.addx, 11, ">", 150, 0, 0, 0);
            if(control.handb)
                xt.drawcs(330 + xt.addy, "(                )", 0, 0, 150, 0);
        } else
    ...
    int handb[] = {
        ...
        8, 10, 8, 12, 7, 7, 7, 7, 12, 7
    };
    float airs[] = {
        1.0F, 1.2F, 0.95F, 1.0F, 2.2F, 1.0F, 0.9F, 0.8F, 1.0F, 1.1F, 
        1.15F, 0.8F, 1.0F, 0.3F, 1.3F, 1.0F, 1.3F, 1.3F, 0.3F, 1.3F
    };
    int airc[] = {
        70, 30, 40, 40, 30, 50, 40, 90, 40, 45, 
        75, 10, 50, 0, 100, 60, 100, 100, 0, 100
    };
    float drag[] = {
    ...
    float grip[] = {
        20F, 27F, 18F, 22F, 19F, 20F, 25F, 20F, 16F, 27F, 
        22.5F, 25F, 30F, 27F, 25F, 27F, 25F, 25F, 25F, 25F
    };
    float bounce[] = {
        1.2F, 1.05F, 1.3F, 1.15F, 1.3F, 1.2F, 1.15F, 1.1F, 1.2F, 1.2F, 
        1.15F, 0.8F, 1.05F, 0.8F, 1.1F, 1.15F, 1.1F, 1.1F, 1.1F, 1.1F
    };
    float simag[] = {
        0.9F, 0.85F, 1.05F, 0.9F, 0.85F, 0.9F, 1.05F, 0.9F, 1.0F, 1.15F, 
        0.9F, 1.1F, 0.9F, 1.3F, 0.9F, 1.15F, 0.9F, 0.9F, 0.9F, 1.05F
    };
    float moment[] = {
        1.2F, 0.75F, 1.4F, 1.0F, 0.85F, 1.25F, 1.4F, 1.3F, 1.2F, 1.85F, 
        1.375F, 2.0F, 1.2F, 3F, 1.5F, 2.0F, 1.5F, 1.5F, 2.2F, 2.7F
    };
    float comprad[] = {
        0.5F, 0.4F, 0.8F, 0.5F, 0.3F, 0.5F, 0.5F, 0.5F, 0.5F, 0.8F, 
        0.5F, 1.0F, 0.5F, 0.6F, 0.5F, 0.8F, 0.5F, 0.5F, 0.5F, 0.5F
    };
    int push[] = {
        2, 2, 3, 3, 2, 2, 2, 4, 2, 2, 
        2, 4, 2, 2, 2, 2, 2, 2, 2, 2
    ...
    int powerloss[] = {
        0x2625a0, 0x2625a0, 0x3567e0, 0x2625a0, 0x3d0900, 0x2625a0, 0x30d400, 0x30d400, 0x29f630, 0x2625a0, 
        0x29f630, 0x44aa20, 0x3567e0, 0xfed260, 0x2dc6c0, 0x53ec60, 0x2dc6c0, 0x2dc6c0, 0xfed260, 0x2dc6c0
    };
    int flipy[] = {
        -50, -60, -92, -44, -60, -57, -54, -60, -77, -100, 
        -82, -85, -28, -100, -63, -127, -63, -63, -63, -63
    };
    int msquash[] = {
        7, 4, 7, 2, 8, 4, 6, 4, 3, 8, 
        4, 10, 3, 20, 3, 8, 3, 3, 23, 3
    };
    int clrad[] = {
        3300, 1700, 4700, 3000, 2000, 4500, 3500, 5000, 10000, 9000, 
        4000, 7000, 10000, 30000, 5500, 5000, 5500, 5500, 10000, 5500
    };
    float dammult[] = {
        0.8F, 1.17F, 0.55F, 1.0F, 0.6F, 0.7F, 0.72F, 0.8F, 0.6F, 0.46F, 
        0.67F, 0.5F, 0.61F, 0.176F, 0.36F, 0.46F, 0.36F, 0.36F, 0.36F, 0.36F
    };
    int maxmag[] = {
        6000, 4200, 20200, 6000, 6000, 9100, 14000, 12000, 12000, 8500, 
        13000, 10700, 13000, 30000, 5800, 18000, 5800, 5800, 15800, 12200
    };
    boolean dominate[];
    boolean caught[];
    int pzy;
