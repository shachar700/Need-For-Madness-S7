...
public class ModSlayer
{
    ...
    static final byte[] sunfmt = { 46, 115, 110, 100, 0, 0, 0, 24, 127, 127, 127, 127, 0, 0, 0, 1, 0, 0, 31, 76, 0, 0, 0, 1, 0, 0, 0, 0 };
    ...
    final void startplaying(boolean flag)
    {
        ...
        } else
        {
            for(int k = 0; k < mod.insts.length; k++)
            {
                ...
                modinstrument1.finetune_rate = (int)(22748294283264L / (long)(mixspeed * (1536 - modinstrument1.finetune_value)));
