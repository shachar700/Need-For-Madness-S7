...
public class RunApp extends Panel {
    ...
    */
    ...
    public static void main(String[] strings) {
        ...
        System.out.println("Editionjar");//Change this to the messgae of your preference
        try {
    ...
    static void startup() {
        frame = new Frame("NFM2 S7 v2 - S7 Edition"); //Change this to the name of your preference
