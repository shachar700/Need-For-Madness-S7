...
public class RunApp extends Panel {
    ...
    */
    ...
    public static void main(String[] strings) {
        ...
        System.out.println("Journeyjar");//Change this to the messgae of your preference
        try {
    ...
    static void startup() {
        frame = new Frame("NFM2 S7 v1 - Your Journey On S7");//Change this to the name of your preference
