...
public class xtGraphics extends Panel
{
    ...
    public void loadmusic(int i, int j, Graphics2D g)
    {
        ...
        if(i == 10 && !loadedt[9])
        {
            stracks[9] = new RadicalMod("music/stage10.zipo", 300, 7900, 125);
    ...
    public void credits(Graphics2D g, Control control)
    {
        ...
        if(flipo == 2)
        {
            ...
            drawcs(g, 153, "This version of the game was modified", 0, 0, 0, 3);
            drawcs(g, 173, "By Shahar Berenson (Shax700)", 0, 0, 100, 3);
            ...
            drawcs(g, 385, "For any comments: youtube.com/shachar700", 0, 0, 0, 3);
        }
        if(flipo == 3)
        {
            g.drawImage(bgmain, 0, 0, null);
