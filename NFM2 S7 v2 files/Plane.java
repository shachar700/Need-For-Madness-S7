    ...
    public void d(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag, int i2) {
        ...
        if (this.embos == 0) {
            ...
            if (this.embos >= 16) {
                ...
                k8 = (int)(0.0f + 0.0f * ((float)this.m.snap[0] / 400.0f));
                if (k8 > 255) {
                    k8 = 255;
                }
                if (k8 < 0) {
                ...
                if ((i9 = (int)(255.0f + 0.0f * ((float)this.m.snap[1] / 300.0f))) > 255) {
                    i9 = 255;
                }
                if (i9 < 0) {
                    i9 = 0;
                }
                if ((k9 = (int)(510.0f + 255.0f * ((float)this.m.snap[2] / 200.0f))) > 255) {
                    k9 = 255;
                }
                if (k9 < 0) {
                    k9 = 0;
                ...
                k8 = (int)(255.0f + 0.0f * ((float)this.m.snap[0] / 400.0f));
                if (k8 > 255) {
                    k8 = 255;
                }
                if (k8 < 0) {
                ...
                if ((k9 = (int)(255.0f + 0.0f * ((float)this.m.snap[2] / 200.0f))) > 255) {
                    k9 = 255;
                }
                if (k9 < 0) {
                    k9 = 0;
        ...
        if (flag2) {
            ...
            Color color = Color.getHSBColor(this.hsb[0], this.hsb[1], this.hsb[2] * f1);
