                    ...
                    if (this.attack == 0) {
                        ...
                        do {
                            ...
                            if (k8 < i9 && this.py(conto.x / 100, checkpoints.opx[i4] / 100, conto.z / 100, checkpoints.opz[i4] / 100) < l8 && this.afta && madness.power > (float)j2) {
                                ...
                                if (checkpoints.stage == 7 || checkpoints.stage == 12) {
                                    j2 = 0;
                                    this.attack = 10000;
                                }
                                if (checkpoints.stage == 17) {
            ...
            if (flag) {
                ...
                if (this.attack == 0) {
                    ...
                    if (!this.bulistc || this.trfix == 2 || this.trfix == 3 || this.trfix == 4 || madness.power < (float)k1) {
                        ...
                        if ((checkpoints.stage == 9 || checkpoints.stage == 16) && this.py(conto.x / 100, checkpoints.opx[0] / 100, conto.z / 100, checkpoints.opz[0] / 100) < 2300) {
                            j4 = conto.xz;
                            if (this.zyinv) {
                                j4 += 180;
                            }
