...
public class Madness {
    ...
    int mxz = 0;
    int cxz = 0;
    float[][] acelf = new float[][]{{11.0f, 5.0f, 3.0f}, {14.0f, 7.0f, 5.0f}, {10.0f, 5.0f, 3.5f}, {11.0f, 6.0f, 3.5f}, {10.0f, 5.0f, 3.5f}, {12.0f, 6.0f, 3.0f}, {7.0f, 9.0f, 4.0f}, {11.0f, 5.0f, 3.0f}, {12.0f, 7.0f, 4.0f}, {12.0f, 7.0f, 3.5f}, {11.5f, 6.5f, 3.5f}, {9.0f, 5.0f, 3.0f}, {13.0f, 7.0f, 4.5f}, {7.5f, 3.5f, 3.0f}, {11.0f, 7.5f, 4.0f}, {12.0f, 6.0f, 3.5f}};
    int[][] swits = new int[][]{{50, 180, 280}, {100, 200, 310}, {60, 180, 275}, {70, 190, 295}, {70, 170, 275}, {60, 200, 290}, {60, 170, 280}, {60, 180, 280}, {90, 210, 295}, {90, 190, 276}, {70, 200, 295}, {50, 160, 270}, {90, 200, 305}, {50, 130, 210}, {80, 200, 300}, {70, 210, 290}};
    int[] handb = new int[]{7, 10, 7, 15, 12, 8, 9, 10, 5, 7, 8, 10, 8, 12, 7, 7};
    float[] airs = new float[]{1.0f, 1.2f, 0.95f, 1.0f, 2.2f, 1.0f, 0.9f, 0.8f, 1.0f, 0.9f, 1.15f, 0.8f, 1.0f, 0.3f, 1.3f, 1.0f};
    int[] airc = new int[]{70, 30, 40, 40, 30, 50, 40, 90, 40, 50, 75, 10, 50, 0, 100, 60};
    ...
    float[] bounce = new float[]{1.2f, 1.05f, 1.3f, 1.15f, 1.3f, 1.2f, 1.15f, 1.1f, 1.2f, 1.1f, 1.15f, 0.8f, 1.05f, 0.8f, 1.1f, 1.15f};
    ...
    float[] comprad = new float[]{0.5f, 0.4f, 0.8f, 0.5f, 0.3f, 0.5f, 0.5f, 0.5f, 0.5f, 0.8f, 0.5f, 1.0f, 0.5f, 0.6f, 0.5f, 0.8f};
    ...
    int[] powerloss = new int[]{2500000, 2500000, 3500000, 2500000, 4000000, 2500000, 3200000, 3200000, 2750000, 5500000, 2750000, 4500000, 3500000, 16700000, 3000000, 5500000};
    int[] flipy = new int[]{-50, -60, -92, -44, -60, -57, -54, -60, -77, -57, -82, -85, -28, -100, -63, -127};
    int[] msquash = new int[]{7, 4, 7, 2, 8, 4, 6, 4, 3, 8, 4, 10, 3, 20, 3, 8};
    int[] clrad = new int[]{3300, 1700, 4700, 3000, 2000, 4500, 3500, 5000, 10000, 15000, 4000, 7000, 10000, 30000, 5500, 5000};
    float[] dammult = new float[]{0.8f, 1.17f, 0.55f, 1.0f, 0.6f, 0.7f, 0.72f, 0.8f, 0.6f, 0.46f, 0.67f, 0.5f, 0.61f, 0.176f, 0.36f, 0.46f};
    int[] maxmag = new int[]{6000, 4200, 7200, 6000, 6000, 9100, 14000, 12000, 12000, 9700, 13000, 10700, 13000, 30000, 5800, 18000};
    ...
    public void drive(Control control, ContO conto, Trackers trackers, CheckPoints checkpoints) {
        ...
        if (this.wtouch && k3 == 2) {
            conto.zy += (int)((double)(this.m.random() * 25.0f * this.speed / (float)this.swits[this.cn][2] - 15.0f * this.speed / (float)this.swits[this.cn][2]) * ((double)this.bounce[this.cn] - 0.9999999999999999));
            conto.xy += (int)((double)(this.m.random() * 25.0f * this.speed / (float)this.swits[this.cn][2] - 15.0f * this.speed / (float)this.swits[this.cn][2]) * ((double)this.bounce[this.cn] - 0.9999999999999999));
        }
        if (this.wtouch && k3 == 1) {
            conto.zy += (int)((double)(this.m.random() * 20.0f * this.speed / (float)this.swits[this.cn][2] - 10.0f * this.speed / (float)this.swits[this.cn][2]) * ((double)this.bounce[this.cn] - 0.9999999999999999));
            conto.xy += (int)((double)(this.m.random() * 20.0f * this.speed / (float)this.swits[this.cn][2] - 10.0f * this.speed / (float)this.swits[this.cn][2]) * ((double)this.bounce[this.cn] - 0.9999999999999999));
        }
